...
# curl -O https://raw.githubusercontent.com/SarahMon-Hub/nginx-certbot-docker-installer/master/install.sh
# chmod +x install.sh
...
"${a_privilege[@]}" curl -o /etc/nginx/nginx.conf https://raw.githubusercontent.com/SarahMon-Hub/nginx-certbot-docker-installer/master/etc/nginx/nginx.conf
"${a_privilege[@]}" curl -o /etc/nginx/conf.d/00.default.conf https://raw.githubusercontent.com/SarahMon-Hub/nginx-certbot-docker-installer/master/etc/nginx/conf.d/00.default.conf
"${a_privilege[@]}" curl -o /etc/nginx/conf.d/01.aspnetcore.conf https://raw.githubusercontent.com/SarahMon-Hub/nginx-certbot-docker-installer/master/etc/nginx/conf.d/01.aspnetcore.conf
...
curl -O https://raw.githubusercontent.com/SarahMon-Hub/nginx-certbot-docker-installer/master/dockers/nginx-certbot/docker-compose.yml
...
curl -O https://raw.githubusercontent.com/SarahMon-Hub/nginx-certbot-docker-installer/master/dockers/aspnetcore/docker-compose.yml
